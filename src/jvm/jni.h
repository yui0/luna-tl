 ...
 *
 * JNI types and vtable layouts follow the Java Native Interface Specification
 * (Oracle).  Only definitions required by Lunaria are included.
 */

#ifndef LUNARIA_JNI_H
#define LUNARIA_JNI_H
