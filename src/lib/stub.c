...
#else
# error "Define one of LUNARIA_STUB_LOG, LUNARIA_STUB_EGL, LUNARIA_STUB_MEDIANDK, LUNARIA_STUB_MATH, LUNARIA_STUB_ZLIB, LUNARIA_STUB_ANDROID, LUNARIA_STUB_OPENSLES"
#endif
